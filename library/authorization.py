...
from library.constant.language import LANGUAGES_TO_ID
from library.functions import time_to_string
from library.constant.custom_error_messages import CUSTOM_ERROR_MESSAGE, DATA_NOT_FOUND

from library.logs import logger
from library.otp import get_otp
from django.core.serializers.json import DjangoJSONEncoder

# from superapp.settings import LANGUAGE_CODE
from testapi.settings import LANGUAGE_CODE
...
def login_exception(code, lang_code):
    if code not in CUSTOM_ERROR_MESSAGE:
        code = DATA_NOT_FOUND
    # if lang_code not in LANGUAGES_TO_ID:
...
def get_language_header(request, default=LANGUAGE_CODE):
